      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
        ...
        <div className="login-card" style={{ 
            ...
            <h2 style={{ marginTop: 0, marginBottom: 24, fontSize: '1.5rem', color: '#0f172a', textAlign: 'center' }}>
                {isRecovering ? 'Recuperar Senha' : 'Acesso Administrativo'}
            </h2>
            ...
            {successMsg ? (
                ...
                <button 
                    ...
                    style={{ 
                        marginTop: 8, 
                        background: '#0f172a', // Botão preto para diferenciar que é Admin
                        color: '#fff',
                        padding: '12px',
                        borderRadius: 8,
                        fontWeight: 600,
                ...
                >
                    {loading ? 'Processando...' : (isRecovering ? 'Enviar Link de Recuperação' : 'Entrar no Painel')}
                </button>
        ...
        <div style={{ color: '#64748b', fontSize: '0.875rem', marginTop: 30 }}>
            &copy; {new Date().getFullYear()} Twinex Tecnologia. Painel Administrativo.
        </div>
      </div>
    </div>
  )
