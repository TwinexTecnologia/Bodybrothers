    ...
    >
      ...
      >
          ...
          {successMsg ? (
            ...
            >
              ...
              <button
                ...
                onMouseOver={(e) =>
                  !loading && (e.currentTarget.style.background = "#0284c7")
                }
                onMouseOut={(e) =>
                  !loading && (e.currentTarget.style.background = "#0ea5e9")
                }
              >
                {loading
                  ? "Processando..."
        ...
        <div style={{ color: "#64748b", fontSize: "0.875rem", marginTop: 10 }}>
          &copy; {new Date().getFullYear()} Twinex Tecnologia. Todos os direitos
          reservados.
        </div>
      </div>
    </div>
